...
namespace PAYONEER.GPM_API
{
    public class GPMLoginAPI
    {
        ...
        public GPMLoginAPI()
        {
            ...
            _apiUrl = "http://" + db.Admins.Where(x => x.Name == "API_URL").FirstOrDefault().Password;
        }
        ...
        /// <returns>View API document</returns>
        public JObject Create(string name, string proxy = "", bool isNoiseCanvas = true)
        {
            // Make api url
